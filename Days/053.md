...
2.  Fix the yaml file:
    ...
    - image: php:7.2-fpm-alpine
        ...
        volumeMounts:
        - mountPath: /var/www/html  //path to be check
        name: shared-files
    ...
    - image: nginx:latest
        ...
        terminationMessagePolicy: File
        volumeMounts:
        - mountPath: /usr/share/nginx/html //path to be check
        name: shared-files
...
3. To see the configmap data:
    ...
    > we can see our nginx root directory is: `/var/www/html`. So update the mount path of nginx container with this. 
