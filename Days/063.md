...
2. Create `iron-gallery-deployment.yaml` file and copy-paste contents from this:
   ```yaml
    apiVersion: apps/v1
    kind: Deployment
    metadata:
...
4. Verify results
    ...
    ```
5. Create `iron-db-deployment.yaml` file and copy-paste contents from this:
            ...
            - name: iron-db-container-xfusion
              ...
              env:
                ...
                - name: MYSQL_ROOT_PASSWORD
                  value: "Str0ngR00t@123"
                - name: MYSQL_PASSWORD
                  value: "Str0ngUser@123"
                - name: MYSQL_USER
                  value: "dbadmin"
              volumeMounts:
                - name: db
...
6. Run the deployment
    ...
    ```
7. Create `iron-gallery-service.yaml` file and copy-paste contents from this:
...
9. Create `iron-db-service.yaml` file and copy-paste contents from this:
   ```yaml
    apiVersion: v1
    kind: Service
    metadata:
...
11. verfiy by accessing the website link from UI if page appears task is successful
