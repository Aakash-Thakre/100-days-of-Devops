...
1. Launch EC2 Instance: Create an EC2 instance named `datacenter-ec2` using any appropriate Ubuntu AMI (you can use AMI `ami-0c02fb55956c7d316`).
...
1. Create a `main.tf` file with these contents:
