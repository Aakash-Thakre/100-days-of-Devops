...
1. create a `redis-config.yaml` file and copy-paste the below content in the file:
...
2. Run the config
   ...
   ``` 
2. create a `redis-deployment.yaml` file and copy-paste the below content in the file:
