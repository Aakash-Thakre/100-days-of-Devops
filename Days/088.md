...
2. Add contents to `playbook.yml` from below"
        ...
        tasks:
          ...
          - name: Add HTML Content
            blockinfile:
              ...
              mode: '0644'
              block: |
                <h1>Welcome to XfusionCorp!</h1>
                <p>This is  Nautilus sample file, created using Ansible!</p>
                <p>Please do not modify this file manually!</p>
      ```
