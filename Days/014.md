...
3. Lets check the port status
    ...
    So `3004` port already being used by sendmail. We already fixed this port conflict. Lets fix the issue 

    4. Changing sendmail port
...
5. Now lets check port and servicec status
