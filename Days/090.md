...
3. Update `playbook.yml` file with below content:

   ```yml
    - name: Managing ACLs Using Ansible on Server 1
      hosts: stapp01
      become: true
      tasks:
    ...
    - name: Managing ACLs Using Ansible on App Server 2
      hosts: stapp02
      become: true
      tasks:
        - name: Create an empty file
        ...
        - name: Give acl permission
          ansible.posix.acl:
            ...
            permissions: rw
            state: present
    - name: Managing ACLs Using Ansible on App Server 3
      hosts: stapp03
      become: true
      tasks:
        - name: Create an empty file
